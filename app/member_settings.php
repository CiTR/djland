	...
	<div class='membership grey clearfix'>
		...
		<div id='member_result' class='container hidden'>
			...
			<div id='row8' class='containerrow'>
				...
				<div class='col6'><input id='email' class='required' name='email' placeholder='Email Address' maxlength='40'></input>
					<div id='email_check' class='green text-center invisible'></div>
				</div>
