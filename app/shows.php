        ...
        <div id='wrapper' ng-show='show.info'>
            ...
            <div ng-show="show.is_admin">
                ...
                <ul id='member_access_list'>
                    <li ng-repeat='member in show.show_owners track by $index'>
                        <a href="membership.php?member_id={{member.id}}">{{member.firstname + " " + member.lastname}}</a>
            ...
            <div ng-show='show.is_admin'>
                ...
                <table>
                    <tr>
                        <td>Playlist
                        <td><input class='smallinput' name='playist' ng-model='show.info.pl_req'>%
                    </tr>
                    <tr>
                        <td>Cancon (20)
                        <td><input class='smallinput' name='cancon_20' ng-model='show.info.cc_20_req'>%
                    </tr>
                    <tr>
                        <td>Cancon (30)
                        <td><input class='smallinput' name='cancon_30' ng-model='show.info.cc_30_req'>%
                    </tr>
                    <tr>
                        <td>Fairplay
                        <td><input class='smallinput' name='femcon' ng-model='show.info.fem_req'>%
                    </tr>
                    <tr>
                        <td>Indie
                        <td><input class='smallinput' name='indy' ng-model='show.info.indy_req'>%
                    </tr>
                </table>
