	...
	<?php print_menu(); ?>
		...
		<div class="center">
			...
			<div class="youCanBookMe_Container">
				<!-- Studio B Booking -->
				<iframe src="https://appointments.citr.ca/?select-service=2&select-provider=3" style="border:0px;background:transparent;" frameborder="0" allowtransparency="true"></iframe></p>
			</div>
			<div class="center" style="max-width:830px">
			...
			<div class="youCanBookMe_Container">
				<!-- Studio C Booking -->
				<iframe src="https://appointments.citr.ca/?select-service=2&select-provider=4" style="border:0px;background:transparent;" frameborder="0" allowtransparency="true"></iframe></p>
			</div>
			<div class="center" style="max-width:830px">
