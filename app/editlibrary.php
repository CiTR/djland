...
<head>
	...
	?>
			...
			<tr>
				<td align=left nowrap>
					...
					<table border=0>
						...
						<tr>
							<td align=left style='padding-left:10px'>Catalog #: </td>
							<td align=left style='padding-left:5px'><INPUT TYPE=text id='ascatalog' size=10></td>
							<td align=left style='padding-left:10px'>Format: </td>
							...
							<td align=left style='padding-left:10px'>Status: </td>
							<td align=left style='padding-left:5px'><INPUT TYPE=text id='asstatus' size=2></td>
						</tr>
						<tr>
							<td align=left style='padding-left:10px'>Artist: </td>
							<td align=left style='padding-left:5px'><INPUT TYPE=text id='asartist'></td>
							<td align=left style='padding-left:10px'>Title: </td>
							<td align=left style='padding-left:5px'><INPUT TYPE=text id='astitle'></td>
							<td align=left style='padding-left:10px'>Label: </td>
							<td align=left style='padding-left:5px'><INPUT TYPE=text id='aslabel'></td>
						</tr>
						<tr>
		...
		foreach ($dbarray as $i => $row) {
			...
			if ($row['cancon'] == 1) echo '<img src="images/tags/cancon.png" title="Canadian Content"  height="15"/>';
			if ($row['femcon'] == 1) echo '<img src="images/tags/fem.png" title="Female Content" height="15"/>';
			if ($row['local'] == 1) echo '<img src="images/tags/local.png" title="Local Content" height="15"/>';
			if ($row['digitized'] == 1) echo '<img src="images/tags/sam.png" title="Digitized" height="15"/>';
