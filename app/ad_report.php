...
?>
  ...
  <head>
    ...
    <title>DJLAND | Ad Report</title>

    <link rel=stylesheet href=css/style.css type=text/css>
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
    <script src="https://code.jquery.com/ui/1.10.2/jquery-ui.js"></script>
    <script type='text/javascript' src='js/ad-report.js?v=20220627'></script>
    <script>
      $(function() {
  ...
  <body class='wallpaper'>
    ...
    <center>
      ...
      <button id='load_charts'>Load</button>
      <button id='sort_charts'>Sort</button>
      <div id='charting-container'>
        <div id='charting-title'>
          <div class='charting-artist'>Type</div>
          <div class='charting-song'>Name</div>
      ...
      <div id='charting-container-sorted'>
        <div id='charting-title'>
          ...
          <div class='charting-artist'>Type</div>
          <div class='charting-album'>Name</div>
