...
class CreatePlayitemsTable extends Migration {
	...
	public function up()
	{
		Schema::create('playitems', function(Blueprint $table)
		{
			...
			$table->boolean('insert_song_start_hour')->nullable()->default(0);
			$table->boolean('insert_song_start_minute')->nullable()->default(0);
			$table->boolean('insert_song_length_minute')->nullable()->default(0);
			$table->boolean('insert_song_length_second')->nullable()->default(0);
