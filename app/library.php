...
<head>
    ...
    ?>
            ...
            <tr>
                ...
                if (permission_level() >= $djland_permission_levels['volunteer']['level'] && isset($_GET['bulkedit'])) {
                    ?><tr>
                <td align=right><input type=submit VALUE="Update" tabindex=32767></td>
                <td></td>
            </tr><?php
    ...
    } elseif (permission_level() >= $djland_permission_levels['volunteer']['level'] && isset($_GET['action']) && $_GET['action'] == "bulkedit") {
        printf("<br><table><tr><td>");
        ...
        while (isset($_POST['id' . $scount]) && isset($_POST['newcat' . $scount])) {
            ...
            } elseif (permission_level() >= $djland_permission_levels['member']['level'] && isset($_GET['action']) && $_GET['action'] == "view") {
        ...
        <?php
                ...
                printf("</div>");
                printf("</div>");
            } elseif (permission_level() >= $djland_permission_levels['volunteer']['level'] && isset($_GET['action']) && ($_GET['action'] == 'add' || $_GET['action'] == 'edit' || $_GET['action'] == 'submit')) {
                printf("<br><table><tr><td>");
        ...
        ?>
            ...
            <center>
                <h1><?= $ed ? "Update" : "Add New"; ?> Record</h1>
                <?php
                    // *** ADD NEW MODE ***
                ...
                <table border=0>
                    <tr align=right>
                        <td>Catalog #: </td>
                        <td align=left><INPUT SIZE=10 TYPE=text NAME=catalog value="<?= $catalog ?>"></td>
                    </tr>
                    <tr align=right>
                        <td>Format : </td>
                    ...
                    <tr>
                        <td>Status: </td>
                        <td><INPUT SIZE=4 TYPE=text NAME=status value="<?= $status ?>"></td>
                    </tr>
                    <tr>
                        <td>Artist: </td>
                        <td><INPUT SIZE=40 TYPE=text NAME=artist value="<?= $artist ?>"></td>
                    </tr>
                    <tr>
                        <td>Title: </td>
                    ...
                    <tr>
                        <td>Label: </td>
                        <td><INPUT SIZE=40 TYPE=text NAME=label value="<?= $label ?>"></td>
                    </tr>
                    <tr>
                        <td>Genre: </td>
                        <td><INPUT SIZE=40 TYPE=text NAME=genre value="<?= $genre ?>"></td>
                    </tr>
                    <tr>
        ...
        <?php
            ...
            // *** VIEW MODE ***
            elseif (permission_level() >= $djland_permission_levels['member']['level']) {
                ...
                <td align=left nowrap>
                    ...
                    <table border=0>
                        <tr>
                            ...
                            <td align=right nowrap>Format: <select name=asformat>
                                    <option value=0>All
                                        <?php
                                        foreach ($fformat_name as $var_key => $var_name) {
                                            printf("<option value=%s>%s", $var_key, $var_name);
                        ...
                        <tr>
                            <td align=right nowrap>Artist: <INPUT TYPE=text NAME=asartist>
                            </td>
                            <td align=right nowrap>Title: <INPUT TYPE=text NAME=astitle>
                        </tr>
                        <tr>
                            <td align=right nowrap>Label: <INPUT TYPE=text NAME=aslabel>
                            </td>
                            <td align=right nowrap>Genre: <INPUT TYPE=text NAME=asgenre>
                        </tr>
                        <tr>
                            <td align=right nowrap>Added: <INPUT TYPE=text NAME=asadded>
                            </td>
                            <td align=right nowrap>Modified: <INPUT TYPE=text NAME=asmodified>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td align=right nowrap>Descending: <input type=checkbox name="asdescending">
