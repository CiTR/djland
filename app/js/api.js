angular.module('djland.api', []).factory('call', function ($http, $location) {
    ...
    return {
        ...
        getReport: function (show_id, from, to, report_type) {
            return $http.post(API_URL_BASE + '/playsheet/report', angular.toJson({
                'show_id': show_id,
                'from': from,
                'to': to,
        ...
        saveFriends: function (friends) {
            return $http.post(API_URL_BASE + '/friends', angular.toJson({
                'friends': friends
            }));
        },
        saveResources: function (resources) {
            return $http.post(API_URL_BASE + '/resource', angular.toJson({
                'resources': resources
            }));
        },
        ...
        saveBroadcasts: function (specialbroadcasts) {
            return $http.post(API_URL_BASE + '/specialbroadcasts', angular.toJson({
                'specialbroadcasts': specialbroadcasts
            }));
        },
        saveAds: function (showtimes) {
            return $http.post(API_URL_BASE + '/adschedule', angular.toJson({
                'showtimes': showtimes
            }));
        },
        saveShow: function (show_object, social_objects, owner_objects, show_time_objects) {
            return $http.put(API_URL_BASE + '/show/' + show_object.id, angular.toJson({
                'show': show_object,
                'social': social_objects,
                'owners': owner_objects,
                'showtimes': show_time_objects
            }));
        },
        saveNewShow: function (show_object, social_objects, owner_objects, show_time_objects) {
            return $http.post(API_URL_BASE + '/show', angular.toJson({
                'show': show_object,
                'social': social_objects,
                'owners': owner_objects,
                'showtimes': show_time_objects
        ...
        savePlaysheet: function (playsheet, playitems, podcast, ads) {
            return $http.post(API_URL_BASE + '/playsheet/' + playsheet.id, angular.toJson({
                'playsheet': playsheet,
                'playitems': playitems,
                'podcast': podcast,
                'ads': ads
        ...
        saveEpisode: function (playsheet, podcast) {
            return $http.post(API_URL_BASE + '/playsheet/' + playsheet.id + '/episode', angular.toJson({
                'playsheet': playsheet,
                'podcast': podcast
            }));
        },
        savePodcast: function (podcast) {
            return $http.put(API_URL_BASE + '/podcast', angular.toJson({
                'podcast': podcast
            }));
        },
        saveNewPlaysheet: function (playsheet, playitems, podcast, ads) {
            return $http.post(API_URL_BASE + '/playsheet', angular.toJson({
                'playsheet': playsheet,
                'playitems': playitems,
                'podcast': podcast,
                'ads': ads
        ...
        error: function (error) {
            return $http.post(API_URL_BASE + '/error', angular.toJson({
                'error': error
            }));
        },
    };
