...
print("<title>Playsheet Q & A</title>");
...
"answer"=>array("You can either play the song in SAM, and the use the SAM tool in the playsheet to add your songs. It will pull the time played and duration for you!","CUE and END buttons are in case you did not play a track through SAM, it helps you estimate both the start time (when you hit cue) and the duration (calculated for you when you hit end)","You have to check the extra fields 'background' and 'theme' if you played a song as either of these.")
); 
...
print("<h1><center>Question and Answer</center></h1>");
