(function () {
    ...
    app.controller('PlaysheetController', function ($filter, $rootScope, $scope, $interval, $timeout, call) {
        ...
        this.changeCRTC = function () {
            if (this.info.crtc == 30) this.info.crtc = 10;
            else if (this.info.crtc == 20) this.info.crtc = 30;
            else this.info.crtc = 20;
        }
        ...
        this.updateShowValues = function (element) {
            ...
            this.active_show = this.member_shows.filter((function (object) {
            ...
            if (this.info.id > 0) {
                call.getPlaysheetData(this.info.id).then(
                    (function (data) {
                        ...
                        this.podcast = playsheet.podcast == null ? {
                            'id': -1,
